...
const Penghargaan = () => {
  ...
  const handleToIntegrasi = () => {
    navigate(`/en/governance-corporate/quality-management/7/ims-00241`);
  };

  const handleTo9001 = () => {
    navigate(`/en/governance-corporate/quality-management/4/iso-9001`);
  };

  const handleTo37001 = () => {
    navigate(`/en/governance-corporate/quality-management/5/iso-37001`);
  };

  const handleTo27001 = () => {
    navigate(`/en/governance-corporate/quality-management/2/iso-27001`);
  };

  const handleTo45001 = () => {
    navigate(`/en/governance-corporate/quality-management/3/iso-45001`);
  };

  const handleTo14001 = () => {
    navigate(`/en/governance-corporate/quality-management/1/iso-14001`);
  };
