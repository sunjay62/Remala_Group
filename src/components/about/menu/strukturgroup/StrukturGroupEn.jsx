    ...
    <>
      <div className="containerStruktur">
        <div className="containerTop" data-aos="fade-right">
          <h3>REMALA ABADI GROUP</h3>
          <p>
            Ownership structure of PT. Remala Abadi Tbk business group <br />
            with ownership percentage exceeding 50%
          </p>
        </div>
        ...
        <div className="containerBottom">
          <h6>Detailed percentage of equity entities : </h6>
