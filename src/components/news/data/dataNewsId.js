const dataNewsId = [
  {
    ...
    date: 'Sabtu, 19 Agustus 2023',
    description:
      'Setiap tahun, tanggal 17 Agustus menjadi momen yang dinanti-nanti oleh seluruh rakyat Indonesia. Tidak terkecuali di lingkungan kantor, di mana semangat kemerdekaan turut diabadikan melalui berbagai acara dan gathering spesial. Acara-acara ini tidak hanya menjadi wadah untuk merayakan hari bersejarah tersebut tetapi juga mempererat hubungan antar-karyawan, menciptakan kenangan indah, dan meningkatkan semangat kerja. ',
    descriptionDetail:
      'Setiap tahun, tanggal 17 Agustus menjadi momen yang dinanti-nanti oleh seluruh rakyat Indonesia. Tidak terkecuali di lingkungan kantor, di mana semangat kemerdekaan turut diabadikan melalui berbagai acara dan gathering spesial. Acara-acara ini tidak hanya menjadi wadah untuk merayakan hari bersejarah tersebut tetapi juga mempererat hubungan antar-karyawan, menciptakan kenangan indah, dan meningkatkan semangat kerja. Berikut adalah gambaran tentang bagaimana acara gathering PT. Remala Abadi pada 17 Agustus dapat menjadi momen tak terlupakan di lingkungan kerja:',
    paragraph1: [
      {
        title: '1. Lomba-Lomba Kreatif dan Menyenangkan',
        description:
          'Acara kantor di Hari Kemerdekaan seringkali dihiasi dengan berbagai lomba kreatif dan menyenangkan. Lomba menghias ruangan dengan tema merah-putih, lomba pakaian tradisional, atau bahkan lomba tarian daerah dapat memeriahkan suasana dan mengeksplorasi sisi kreatif karyawan. Partisipasi dalam lomba semacam ini tidak hanya memberikan kesenangan tetapi juga memupuk semangat tim di antara rekan kerja.',
        images: [
    ...
    paragraph2: [
      {
        title: '2. Makan bersama',
        description:
          'Makanan adalah bagian tak terpisahkan dari perayaan kemerdekaan. Acara kantor 17 Agustus seringkali menawarkan hidangan yang enak. kehadiran makanan-makanan ini bukan hanya memuaskan lidah tetapi juga menjadi simbol ikatan yang lebih erat di antara karyawan.',
      },
    ],
    paragraph3: [
      {
        title: '3. Hiburan dan Pertunjukan Karyawan',
        description:
          'Agar acara kantor semakin meriah, pertunjukan dan hiburan dari para karyawan sendiri dapat menjadi pilihan yang menarik. Mulai dari pentas seni, grup band internal, hingga pertunjukan drama, partisipasi karyawan dalam memberikan hiburan menciptakan atmosfer yang penuh keceriaan. Ini juga memberikan kesempatan bagi karyawan untuk menunjukkan bakat mereka di luar konteks pekerjaan sehari-hari.',
        images: [
    ...
    paragraph4: [
      {
        title: '4. Penghargaan dan Penyampaian Hadiah',
        description1:
          'Menghargai kontribusi karyawan dalam perayaan 17 Agustus adalah langkah yang sangat positif. Acara kantor dapat mencakup sesi penghargaan dan penyampaian hadiah untuk karyawan yang menonjol dalam berbagai kegiatan atau lomba. Ini tidak hanya memberikan apresiasi kepada individu tetapi juga mendorong semangat karyawan untuk berpartisipasi secara aktif dalam kegiatan kantor.',
        images: [
        ...
        description2:
          'Perayaan 17 Agustus di lingkungan kantor bukan hanya sekadar acara formal tetapi juga ajang untuk mengekspresikan kebanggaan akan identitas nasional dan kebersamaan. Dengan menggabungkan unsur kesenangan, semangat kompetisi yang sehat, dan penghormatan terhadap nilai-nilai kemerdekaan, acara kantor dan gathering pada tanggal 17 Agustus dapat menjadi momentum berharga untuk menciptakan kenangan yang tak terlupakan di antara rekan kerja.',
      },
    ],
  },
  {
    ...
    descriptionDetail:
      'Di era digital yang semakin berkembang, konektivitas internet menjadi salah satu faktor kunci dalam menunjang berbagai aktivitas, termasuk dalam menghadiri event-event penting. Salah satu contoh event yang kini semakin digemari oleh berbagai kalangan adalah Indonesia Digital Meetup (IDM) yang diselenggarakan di SMESCO Indonesia. Tahun ini, Remala Abadi membantu berlangsungnya event Indonesia Digital Meetup dengan mejadi penyedia Tunggal layanan internet kepada para pengunjung yang hadir. Selain itu Remala Abadi juga melakukan Sesi Presentasi Produk Layanan dan inovasi Digital serta membuka kesempatan untuk peluang mitra Bisnsi UMKM untuk menjadi  mitra bisnis dalam bidang Internet Service Provider. Beberpa Kegiatan yang di lakukan adalah sebagai berikut ini : ',
    description:
      'Di era digital yang semakin berkembang, konektivitas internet menjadi salah satu faktor kunci dalam menunjang berbagai aktivitas, termasuk dalam menghadiri event-event penting. Salah satu contoh event yang kini semakin digemari oleh berbagai kalangan adalah Indonesia Digital Meetup (IDM) yang diselenggarakan di SMESCO Indonesia.  ',
    paragraph1: [
      {
        title: '1. BOOTH REMALA ABADI',
        description:
          'Dalam event IDM SMSECO, pelaku-pelaku bisnis inovasi digital turut membuka booth ini  adalah bentuk langkah inovatif yang memungkinkan pengunjung untuk mencari informasi dan membandingkan kualitas dan pelayanan yang terbaik secara tatap muka. Remala Abadi turut pula meramaikan event ini dengan membuka booth, yang merupakan kesempatan baik untuk berinteraksi langsung dengan calon pelanggan atau UMKM yang ingin bekerja sama dan memperkenalkan layanan internet terbaik yang dimiliki.',
        images: [require('../image/idm/idm3.jpg'), require('../image/idm/idm1.jpg'), require('../image/idm/idm2.jpg')],
      },
    ],
    paragraph2: [
      {
        title: '2. Memperkenalkan Produk dan Layanan Unggulan',
        description:
          'Remala Abadi turut pula berpartisipasi sebagai pembicara dalam Event Digital Meet Up ini. Kami menampilkan informasi produk dan layanan  serta juga memberikan informasi mengenai perkembangan inovasi digital terbaru yang tentunya harus di dukung oleh koneksi jaringan yang stabil dan cepat. Selain sebagai penyedia layanan Internet, kami juga membuka kesempatan bagi mitra-mitra UMKM yang tertarik menjadi mitra bisnis dalam bidang Internet Service Provider.',
        images: [require('../image/idm/idm5.jpg'), require('../image/idm/idm6.jpg'), require('../image/idm/idm7.jpg')],
      },
    ],
    paragraph3: [
      {
        title: '3. Demo Teknologi Terbaru',
        description:
          'Selain memperkenalkan produk dan layanan, Kami juga melakukan demo teknologi terbaru sehingga pengunjung dapat melihat langsung bagaimana Remala Abadi menyediakan konektivitas internet yang handal dan inovatif, Para pelaku usaha UMKM mendapatkan ganbaran mengenai jenis layanan dan  kualitas layanan yang kami sediakan.',
      },
    ],
    paragraph4: [
      {
        title: '4. Memberikan Konsultasi Personal',
        description:
          'Pada event ini juga kami memberikan kesempatan bagi calon pelanggan untuk berbicara langsung dengan tim Remala Abadi. Mereka dapat mengajukan pertanyaan, meminta saran, dan mendapatkan konsultasi pribadi tentang kebutuhan mereka didalam bidang internet servis provider ini. Ini adalah kesempatan penting untuk memahami kebutuhan pelanggan / UMKM dan memberikan solusi yang sesuai.',
      },
    ],
    paragraph5: [
      {
        title: '5. Menyediakan Akses Internet Selama Event',
        description1:
          'Selain sebagai peserta dalam kegiatan Digital meet up.Remala Abadi juga menjadi  penyedia tunggal akses internet di Gedung SMESCO selama event berlangsung. Ini memungkinkan pengunjung untuk tetap terhubung, mengakses informasi penting, dan berbagi pengalaman melalui media sosial selama event berlangsung. Dengan layanan ini, Remala Abadi menunjukkan komitmen mereka untuk memberikan layanan terbaik dimanapun, kapanpun dan dalam situasi apapun.',
        images: [require('../image/idm/idm8.jpg'), require('../image/idm/idm4.jpg')],
        description2:
          'Partisipasi Remala Abadi dalam event Indonesia Digital Meetup SMESCO merupakan langkah inovatif yang memungkinkan pengunjung untuk memiliki pengalaman terbaik dalam hal konektivitas internet. Dengan membuka booth, memberikan informasi terkini tentang produk dan layanan, serta menyediakan akses internet selama event, Remala Abadi menjelaskan bahwa mereka bukan hanya sekadar penyedia internet, tetapi juga mitra yang peduli terhadap kebutuhan konektivitas Anda. Event IDM SMESCO menjadi bukti bahwa konektivitas yang handal sangat penting dalam era digital, dan Remala Abadi hadir untuk memenuhi kebutuhan tersebut.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: 'PT. Remala Abadi Tbk Sertifikasi ISO 20000-1:2018 Sucofindo.',
    titleDetail: 'Menghadirkan Layanan Internet Premium dengan Standar ISO 20000-1:2018',
    date: 'Selasa, 25 Oktober 2023',
    descriptionDetail:
      'PT. Remala Abadi Tbk (Remala) merupakan salah satu perusahaan terkemuka di Indonesia yang bergerak dalam bidang jasa penyedia layanan Internet Service Provider (ISP). Dengan komitmen untuk memberikan layanan internet berkualitas tinggi kepada pelanggan, Remala telah berhasil mendapatkan Sertifikasi ISO 20000-1:2018, standar internasional untuk manajemen layanan teknologi informasi.',
    date: 'Selasa, 25 Oktober 2023',
    description:
      'PT. Remala Abadi Tbk (Remala) merupakan salah satu perusahaan terkemuka di Indonesia yang bergerak dalam bidang jasa penyedia layanan Internet Service Provider (ISP). Dengan komitmen untuk memberikan layanan internet berkualitas tinggi kepada pelanggan, Remala telah berhasil mendapatkan Sertifikasi ISO 20000-1:2018.',
    paragraph1: [
      {
        description:
          'Pada tanggal 25 Oktober 2023, Remala menerima Sertifikasi ISO dari ACS Indonesia, yang mencakup ISO 20000-1:2018, Sistem Manajemen Layanan. Ini menunjukkan komitmen Remala dalam menyediakan layanan internet yang berkualitas.',
      },
    ],
    paragraph2: [
      {
        description:
          'Sertifikasi ISO 20000-1:2018 menegaskan komitmen Remala dalam memberikan layanan internet yang handal, aman, dan berkualitas tinggi kepada pelanggan. Standar ini mengatur berbagai prosedur dan praktik terbaik dalam manajemen layanan teknologi informasi, termasuk pengelolaan risiko, pemantauan kinerja, dan pengembangan layanan berkelanjutan.',
      },
    ],
    paragraph3: [
      {
        description:
          'Dengan tersertifikat ISO 20000-1:2018, Remala menunjukkan kepada pelanggan bahwa perusahaan ini memiliki sistem manajemen layanan teknologi informasi yang terstruktur dan terstandarisasi. Hal ini memberikan kepercayaan kepada pelanggan bahwa layanan internet yang disediakan oleh Remala memenuhi standar internasional yang ketat.',
      },
    ],
    paragraph4: [
      {
        description:
          'Richard Kartawijaya, Chief Executive Officer (CEO) PT. Remala Abadi.Tbk, mengatakan "Sertifikasi ISO 20000-1:2018 juga membantu Remala dalam meningkatkan efisiensi operasional, mengurangi risiko, dan meningkatkan kepuasan pelanggan". Dengan adopsi standar internasional ini, perusahaan dapat terus mengembangkan layanan internetnya sesuai dengan tuntutan pasar dan perkembangan teknologi informasi yang terus berubah.',
      },
    ],
    paragraph5: [
      {
        description:
          'Dengan demikian, Remala tidak hanya menjadi penyedia layanan Internet Service Provider terkemuka di Indonesia, tetapi juga menjadi perusahaan yang berkomitmen untuk memberikan layanan internet premium dengan standar kualitas tinggi yang diakui secara internasional melalui sertifikasi ISO 20000-1:2018.',
      },
    ],
  },
  // {
